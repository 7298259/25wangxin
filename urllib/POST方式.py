...
>>> import urllib
>>> import urllib2
>>> values = {"username":"7298259@qq.com","password":"xin0507.."}
...
<html>
  <head>
    ...
    <link type="text/css" rel="stylesheet" href="/css/bootstrap.css;jsessionid=24B3062CC4958753891CB5A31B874265.tomcat1" />
    <link type="text/css" rel="stylesheet" href="/css/login.css;jsessionid=24B3062CC4958753891CB5A31B874265.tomcat1" />
    <link type="text/css" rel="stylesheet" href="/css/weixinqr.css;jsessionid=24B3062CC4958753891CB5A31B874265.tomcat1" />
  ...
  <body>
            ...
            <div class="login-part">
              ...
              <div class="user-info">
                <div class="user-pass">
                  ...
                  <form id="fm1" action="/account/login;jsessionid=24B3062CC4958753891CB5A31B874265.tomcat1?from=http://my.csdn.net/my/mycsdn" method="post">
					...
					<input type="hidden" name="lt" value="LT-310317-Ogg2vwWz5wjioUf5dclcmviVlkfhVC" />
              ...
              <div class="third-part tracking-ad" data-mod="popu_27">
              	...
              	<a id="qqAuthorizationUrl" href="https://graph.qq.com/oauth2.0/authorize?response_type=code&client_id=100270989&redirect_uri=https%3A%2F%2Fpassport.csdn.net%2Faccount%2Flogin%3Foauth_provider%3DQQProvider&state=test" class="qq"></a>
                   	...
                   	<script src="/js/apps/weixinqr.js;jsessionid=24B3062CC4958753891CB5A31B874265.tomcat1"></script>
    ...
    <script data-main="/js/login-config.js;jsessionid=24B3062CC4958753891CB5A31B874265.tomcat1" src="/js/libs/require.js;jsessionid=24B3062CC4958753891CB5A31B874265.tomcat1"></script>
    <script type="text/javascript">
